...
<!-- Inicio - Formulário -->
<form method="post" action="services/altera_ganhos.php">
	...
	<div class="row linha2" style="margin-top: 30px; margin-left: 15px;">
		...
		<div class="col-sm-4">
			<div class="input-group">
				...
				<input type="text" class="form-control" id="valor_renda" name="valor_renda" value="<?php echo $ganhos['valor'] ?>">
			</div>
		</div>
	...
	<div class="row" style="margin-top: 30px; margin-left: 15px;">
		...
		-->
		<div class="col-sm-0">
			<a href="index.php?sec=cadastrar_ganho">
