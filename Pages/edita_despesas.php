...
<?php
	...
	$valor_parcela = $forma_pagamento_parcelado['valor_parcela'];
...
<!-- Inicio - Formulário -->
<form method="post" action="services/altera_despesas.php">
		...
		<div class="col-sm-3" style="margin-top: 10px;">
			<div id="despesa_fixa" class="form-check">
			    <label class="form-check-label">
			        <input class="form-check-input" type="checkbox" <?=($despesas['despesa_fixa'] == "Sim")?'checked="checked"':''?> value="Sim" name="despesa_fixa">
			        	Despesa Fixa?
	...
	<div class="row" id="mostra_linha_vista" style="margin-top: 25px; margin-left: 15px; display: <?php echo $mostrar_a_vista; ?>;">
		...
		<div class="col-sm-3">
			<div class="input-group">
				...
				<input type="text" class="form-control" id="valor_despesa" name="valor_despesa" value="<?php echo $valor_a_vista ?>">
			</div>
		</div>
	</div>
			...
			<div class="dropdown bootstrap-select form-control form-control-sm dropup ">
              	<select class="form-control selectpicker" data-style="btn btn-link" id="cartao_pagamento_parcelado" name="cartao_pagamento_parcelado">
		            ...
		            <?php while ( $cartoes_p = $sel_cartoes_p->fetch_assoc() ) : ?>
		                <option value="<?php echo $cartoes['id'] ?>" <?=($cartoes_p['id'] == $cartao_utilizado_p)?'selected':''?>><?php echo $cartoes_p['titulo'] ?></option>
		            <?php endwhile; ?>
	...
	<div id="linha_parcelas_valor" class="row" style="margin-top: 25px; display: <?php echo $mostrar_parcelado; ?>;">
		...
		<div class="col-sm-5" style="margin-left: 15px;">
			<div class="input-group">
				...
				<input type="text" class="form-control" id="valor_parcelas" name="valor_parcelas" value="<?php echo $valor_parcela ?>">
			</div>
		</div>
	</div>
