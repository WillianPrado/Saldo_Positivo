...
<form method="post" action="services/cadastra_tipo_despesas.php">
	<div class="row">
		<div class="col-sm-3">
			<div class="input-group dates">
				...
				<input id="tipo_ganho" type="text"  class="form-control" name="tipo_despesa">
			</div>
		</div>
	</div>
		        ...
		        <table class="table table-hover">
		            <thead class="text-info text-center">
		            	...
		            	<?php
							...
							$sql_cadastrar_tipo_despesas = "SELECT * FROM tipos_de_despesas ORDER BY tipo_despesa ASC";
		            ...
		            <tbody class="text-center">
		                ...
		                <tr>
		                    ...
		                    <td class="td-actions text-center">
				                <a href="index.php?sec=edita_tipo_despesas&id=<?php echo $tipos['id'] ?>">
				                	<button type="button" rel="tooltip" class="btn btn-success" title="Editar">
				                    	<i class="material-icons">edit</i>
				               		</button>
				                </a>

				                <a href="index.php?sec=deleta_tipo_despesas&id=<?php echo $tipos['id'] ?>">
